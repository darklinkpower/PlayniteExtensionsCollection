function GetGameMenuItems
{
    ...
    if ([Playnite.SDK.BuiltinExtensions]::GetExtensionFromId($game.PluginId) -eq "SteamLibrary")
    {
        ...
        $menuItem8.Description =  [Playnite.SDK.ResourceProvider]::GetString("LOCSteam_Viewer_MenuItemGameWorkshopDescription")
        $menuItem8.FunctionName = "Start-Workshop"
        $menuItem8.MenuSection = $extensionName

        $menuItem9 = New-Object Playnite.SDK.Plugins.ScriptGameMenuItem
        $menuItem9.Description =  [Playnite.SDK.ResourceProvider]::GetString("LOCSteam_Viewer_MenuItemGameLibraryDescription")
        $menuItem9.FunctionName = "Start-Library"
        $menuItem9.MenuSection = $extensionName

        return $menuItem1, $menuItem2, $menuItem3, $menuItem4, $menuItem5, $menuItem6, $menuItem7, $menuItem8, $menuItem9, $menuItem10, $menuItem11, $menuItem12, $menuItem13, $menuItem14, $menuItem154
    }
    else
    {
...
function Start-Workshop
{
    ...
    $game = $scriptGameMenuItemActionArgs.Games | Select-Object -last 1
    $url =  "https://steamcommunity.com/app/{0}/workshop" -f $game.GameId
    $uri = "steam://openurl/{0}" -f $url
    Start-Process $uri
}
