...
namespace GameEngineChecker
{
    ...
    {
        private readonly GameEngineChecker plugin;
        private GameEngineCheckerSettings editingClone { get; set; }

        private GameEngineCheckerSettings settings;
        ...
        public GameEngineCheckerSettingsViewModel(GameEngineChecker plugin)
        {
            ...
            {
                Settings = new GameEngineCheckerSettings();
            }
        }
