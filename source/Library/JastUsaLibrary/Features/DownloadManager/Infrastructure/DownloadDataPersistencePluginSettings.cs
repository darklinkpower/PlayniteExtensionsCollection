...
{
    public class DownloadDataPersistencePluginSettings : IDownloadDataPersistence
    {
        private readonly JastUsaLibrarySettingsViewModel _settingsViewModel;

        public DownloadDataPersistencePluginSettings(JastUsaLibrarySettingsViewModel settingsViewModel)
        {
