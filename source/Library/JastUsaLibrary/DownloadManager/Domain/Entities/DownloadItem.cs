...
namespace JastUsaLibrary.DownloadManager.Domain.Entities
{
    ...
    public class DownloadItem : INotifyPropertyChanged, IDisposable
    {
        ...
        public DownloadItem(JastUsaAccountClient jastAccountClient, DownloadData downloadData, DownloadsManager downloadsManagerViewModel, IEventAggregator eventBus)
        {
        ...
        private void StateChangedCallback(DownloadStateArgs args)
        {
            ...
            _eventBus.Publish(new DownloadItemStatusChangedEventArgs(this, newStatus));
            NotifyCommandsPropertyChanged();
        }
        ...
        {
            _eventBus.Publish(new DownloadItemProgressChangedEventArgs(this, downloadProgressArgs));
        }
