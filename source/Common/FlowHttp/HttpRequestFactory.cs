...
namespace FlowHttp
{
    ...
    internal static class HttpRequestFactory
    {
        ...
        public static FlowHttpRequest GetFlowHttpRequest() => new FlowHttpRequest(_httpClientFactory);
        ...
        /// <returns>An instance of FlowHttpRequest for configuring the settings of an HTTP request.</returns>
        public static FlowHttpRequest GetFlowHttpRequest(string url) => new FlowHttpRequest(_httpClientFactory).WithUrl(url);
        ...
        public static FlowHttpFileRequest GetFlowHttpFileRequest() => new FlowHttpFileRequest(_httpClientFactory);
        ...
        /// <returns>An instance of FlowHttpFileRequest for configuring the settings of an HTTP request for file download.</returns>
        public static FlowHttpFileRequest GetFlowHttpFileRequest(string url) => new FlowHttpFileRequest(_httpClientFactory).WithUrl(url);
        ...
        /// <returns>An instance of FlowHttpFileRequest for configuring the settings of an HTTP request for file download.</returns>
        public static FlowHttpFileRequest GetFlowHttpFileRequest(string url, string downloadPath) => new FlowHttpFileRequest(_httpClientFactory)
            .WithUrl(url)
