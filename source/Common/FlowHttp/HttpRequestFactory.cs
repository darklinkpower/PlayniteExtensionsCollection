...
namespace FlowHttp
{
    ...
    internal static class HttpRequestFactory
    {
        ...
        internal static FlowHttpRequest GetHttpRequest() => new FlowHttpRequest(_httpClientFactory);
        ...
        /// <returns>An instance of FlowHttpRequest for configuring the settings of an HTTP request.</returns>
        internal static FlowHttpRequest GetHttpRequest(string url) => new FlowHttpRequest(_httpClientFactory).WithUrl(url);
        ...
        internal static FlowHttpFileRequest GetHttpFileRequest() => new FlowHttpFileRequest(_httpClientFactory);
        ...
        /// <returns>An instance of FlowHttpFileRequest for configuring the settings of an HTTP request for file download.</returns>
        internal static FlowHttpFileRequest GetHttpFileRequest(string url) => new FlowHttpFileRequest(_httpClientFactory).WithUrl(url);
        ...
        /// <returns>An instance of FlowHttpFileRequest for configuring the settings of an HTTP request for file download.</returns>
        internal static FlowHttpFileRequest GetHttpFileRequest(string url, string downloadPath) => new FlowHttpFileRequest(_httpClientFactory)
            .WithUrl(url)
