...
namespace VNDBMetadata
{
    public class VNDBMetadataProvider : OnDemandMetadataProvider
    {
        ...
        public override string GetDescription(GetMetadataFieldArgs args)
        {
            ...
            DownloadExtensions.DownloadFileAsync(QueryConstants.DatabaseDumps.TagsUrl, "somefolder");
        ...
        private async void test()
        {
            ...
            var ss = text.DownloadFileAsync(QueryConstants.DatabaseDumps.TagsUrl, "somefolder");
            var sws = DownloadExtensions.DownloadFileAsync(QueryConstants.DatabaseDumps.TagsUrl, "somefolder");
        }
