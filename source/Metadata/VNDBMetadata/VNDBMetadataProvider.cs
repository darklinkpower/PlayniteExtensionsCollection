...
namespace VNDBMetadata
{
    public class VNDBMetadataProvider : OnDemandMetadataProvider
    {
        ...
        public VNDBMetadataProvider(MetadataRequestOptions options, VndbService vndbService, VNDBMetadataSettingsViewModel settings, BbCodeProcessor bbcodeProcessor)
        {
