...
namespace VndbApi.Infrastructure.CharacterAggregate
{
    public static class CharacterFilterFactory
    {
        ...
        public static class VisualNovel
        {
            ...
            private static SimpleFilterBase<Character> CreateFilter(string operatorString, SimpleFilterBase<Domain.VisualNovelAggregate.VisualNovel> value) =>
                FilterFactory.CreateFilter<Character, SimpleFilterBase<Domain.VisualNovelAggregate.VisualNovel>>(FilterName, CanBeNull, operatorString, value);

            private static SimpleFilterBase<Character> CreateFilter(string operatorString, ComplexFilterBase<Domain.VisualNovelAggregate.VisualNovel> value) =>
                FilterFactory.CreateFilter<Character, ComplexFilterBase<Domain.VisualNovelAggregate.VisualNovel>>(FilterName, CanBeNull, operatorString, value);

            public static SimpleFilterBase<Character> EqualTo(SimpleFilterBase<Domain.VisualNovelAggregate.VisualNovel> value) =>
                CreateFilter(RequestConstants.Operators.Matching.IsEqual, value);

            public static SimpleFilterBase<Character> NotEqualTo(SimpleFilterBase<Domain.VisualNovelAggregate.VisualNovel> value) =>
                CreateFilter(RequestConstants.Operators.Matching.NotEqual, value);

            public static SimpleFilterBase<Character> EqualTo(ComplexFilterBase<Domain.VisualNovelAggregate.VisualNovel> value) =>
                CreateFilter(RequestConstants.Operators.Matching.IsEqual, value);

            public static SimpleFilterBase<Character> NotEqualTo(ComplexFilterBase<Domain.VisualNovelAggregate.VisualNovel> value) =>
                CreateFilter(RequestConstants.Operators.Matching.NotEqual, value);
        }
