...
namespace VndbApiInfrastructure.ReleaseAggregate
{
    public static class ReleaseFilterFactory
    {
        ...
        public static class Producer
        {
            ...
            private static SimpleFilterBase<Release> CreateFilter(string operatorString, SimpleFilterBase<VndbApiDomain.ProducerAggregate.Producer> value) =>
                FilterFactory.CreateFilter<Release, SimpleFilterBase<VndbApiDomain.ProducerAggregate.Producer>>(FilterName, CanBeNull, operatorString, value);

            private static SimpleFilterBase<Release> CreateFilter(string operatorString, ComplexFilterBase<VndbApiDomain.ProducerAggregate.Producer> value) =>
                FilterFactory.CreateFilter<Release, ComplexFilterBase<VndbApiDomain.ProducerAggregate.Producer>>(FilterName, CanBeNull, operatorString, value);

            public static SimpleFilterBase<Release> EqualTo(SimpleFilterBase<VndbApiDomain.ProducerAggregate.Producer> value) =>
                CreateFilter(RequestConstants.Operators.Matching.IsEqual, value);

            public static SimpleFilterBase<Release> NotEqualTo(SimpleFilterBase<VndbApiDomain.ProducerAggregate.Producer> value) =>
                CreateFilter(RequestConstants.Operators.Matching.NotEqual, value);

            public static SimpleFilterBase<Release> EqualTo(ComplexFilterBase<VndbApiDomain.ProducerAggregate.Producer> value) =>
                CreateFilter(RequestConstants.Operators.Matching.IsEqual, value);

            public static SimpleFilterBase<Release> NotEqualTo(ComplexFilterBase<VndbApiDomain.ProducerAggregate.Producer> value) =>
                CreateFilter(RequestConstants.Operators.Matching.NotEqual, value);
        }
