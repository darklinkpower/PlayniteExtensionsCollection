...
namespace OpenCriticMetadata
{
    ...
    public class OpenCriticMetadataSettingsViewModel : ObservableObject, ISettings
    {
        ...
        private OpenCriticMetadataSettings settings;
        public OpenCriticMetadataSettings Settings
        {
            get => settings;
            set
            {
        ...
        public OpenCriticMetadataSettingsViewModel(OpenCriticMetadata plugin)
        {
